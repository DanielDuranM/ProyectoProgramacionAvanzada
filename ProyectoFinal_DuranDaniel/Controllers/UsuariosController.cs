...
namespace ProyectoFinal_DuranDaniel.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,CorreoPersonal,Identificacion,Telefono,ContrasenaHash,RolId")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,CorreoPersonal,Identificacion,Telefono,ContrasenaHash,RolId")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
